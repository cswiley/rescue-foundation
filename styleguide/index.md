...
<div class="card rounded-icon-card text-center">
    <div class="circle-icon">
                    <i class="fa fa-eye" aria-hidden="true"></i>
                    </div>
    <div class="card-content">
                    <div class="card-section" data-equalizer-watch="card">
                <div class="title"><h4 class="transform-none">Know a store that is illegally selling tobacco to minors? Let us know.</h4></div>
                <p class="description"></p>
            </div>
                            <div class="card-divider">
                    <a target="_blank" href="https://www.accessdata.fda.gov/scripts/ptvr/index.cfm" class="button">Report a violation</a>
                </div>
                        </div>
</div>
```
